...
\begin{frame}
  ...
  \end{equation}
  \begin{itemize}
  \item $u_{0}$ is a reference value at a reference temperature $T$
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics<1>[width=7cm]{figures/fig_5_01}
...
\begin{frame}
  ...
  \begin{block}{Flow Law}
    ...
    \begin{equation*}
      \begin{array}{lrclc}
              \text{Glen's flow law}\quad & \mathbf{T}' & = & 2\,\eta\,\mathbf{D}  = 1/2 A(T)^{-1/n}\varepsilon_{\text{e}}^{\frac{1-n}{n}} \mathbf{D} \quad &(6)
      \end{array}
    \end{equation*}
  \end{block}
  \begin{itemize}
...
\begin{frame}
  ...
  \end{equation}
  \begin{itemize}
  \item execpt for the uppermost few centimeters of ice,\\ radiation is negligible
 \end{itemize}
  \begin{equation}
...
\begin{frame}
  ...
  \end{figure}
  \begin{itemize}
  \item will not derive transition/boundary conditions
  \end{itemize}
\end{frame}
  ...
  \frametitle{Modeling}
   \begin{itemize}
      \item numerical models
        \item analytical solutions for further simplified problems
    \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Analytical Solutions}
   \begin{itemize}
    \item gravity-driven thin film flow (p. 46\,--\,48)
